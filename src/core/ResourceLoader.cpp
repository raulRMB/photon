...
void ResourceLoader::WriteMipMaps(const wgpu::Device &device, wgpu::Texture texture, wgpu::Extent3D textureSize,
                                  u32 mipLevelCount, const unsigned char *pixelData)
{
